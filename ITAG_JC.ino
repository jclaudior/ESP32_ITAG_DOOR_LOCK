...
String itagsRegistered[] = {"fc:58:fa:b7:5a:e5", "fc:58:fa:b3:89:21"};

class MyAdvertisedDeviceCallbacks: public BLEAdvertisedDeviceCallbacks {

    void onResult(BLEAdvertisedDevice advertisedDevice) {
      for (int i = 0; i < (sizeof(itagsRegistered) / sizeof(itagsRegistered[0])); i++){
        if(strcmp(advertisedDevice.getAddress().toString().c_str(), itagsRegistered[i].c_str()) == 0){
